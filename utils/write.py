...
def get_glove():
    ...
    embeddings_path = './data/glove/glove.6B.50d.trimmed.txt'
...
def trim_embeddings():
    ...
    with open("./data/glove/glove.6B.50d.txt", encoding="utf-8") as f:
        with open("./data/glove/glove.6B.50d.trimmed.txt", "w") as f2:
            for line in f:
